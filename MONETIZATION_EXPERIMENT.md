...
- Proactive qualified first-touch cap is 12 total for the continuing mission; all previously sent GP-RS1 first touches count toward the 12. Maximum 2 new candidate investigations per wake and maximum 3 confirmed proactive first touches in any rolling 24h. Before any send, require current Sponsors-rail usability, a purpose-appropriate public business contact, applicable jurisdiction/entity/channel permissibility, published contact restrictions, full Gmail history dedupe by recipient/domain/campaign, permanent opt-out/bounce suppression, remaining caps, truthful sender identity, the required opt-out mechanism, and exactly-once SENT verification. No automatic follow-up.
